...
def build_receipt_image(payload):
    ...
    # Increase canvas limit to support very long receipts (approx 3.75 meters at 203 DPI)
    image = Image.new('RGB', (width_px, 30000), 'white')
...
def print_image(printer_name, image):
    ...
    scaled_full_height = int(image.height * scale_ratio)
    
    # Start Document
    hdc.StartDoc('Valmu Admin Receipt')
